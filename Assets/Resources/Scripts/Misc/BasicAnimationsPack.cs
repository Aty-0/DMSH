...
{
    public static IEnumerator SmoothAwakeText(Text text, float alphaOnStart = 0.0f, float speed = 15.0f, float seconds = 0.01f)
    {
        alphaOnStart = (alphaOnStart == 0.0f) ? text.color.a : alphaOnStart;
        float alpha = 0.0f;
